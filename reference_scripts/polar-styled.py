"""polar-styled.py — Reference for examples/polar-styled.lisp"""
import matplotlib
matplotlib.use('Agg')
...
ax.plot(x_data, y_data, color='darkred', linewidth=2.5, zorder=2)

title_pad_px = 6.0 * (100.0 / 72.0) + 1.0
y_title = 1.0 + title_pad_px / DH
ax.text(0.5, y_title, 'Styled Polar Plot',
