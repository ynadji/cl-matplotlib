"""violin-comparison.py — Reference for examples/violin-comparison.lisp"""
import matplotlib
matplotlib.use('Agg')
...
data_a = [10.0, 11.0, 12.0, 13.0, 14.0, 15.0, 15.0,
          16.0, 17.0, 18.0, 19.0, 20.0, 21.0]
data_b = [5.0, 7.0, 9.0, 10.0, 11.0, 13.0, 15.0,
          17.0, 19.0, 21.0, 23.0, 25.0, 27.0]
data_c = [12.0, 14.0, 15.0, 16.0, 16.0, 17.0, 17.0,
          18.0, 18.0, 18.0, 19.0, 20.0, 22.0]
data_d = [3.0, 5.0, 8.0, 12.0, 15.0, 18.0, 20.0,
          22.0, 25.0, 28.0, 32.0, 38.0, 45.0]
