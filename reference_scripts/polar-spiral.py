"""polar-spiral.py — Reference for examples/polar-spiral.lisp"""
import matplotlib
matplotlib.use('Agg')
...
# Archimedean spiral: r = θ/(2π), θ from 0 to 4π (two full turns)
theta = np.linspace(0, 4 * np.pi, 301)
r = theta / (2 * np.pi)
...
ax.plot(x_data, y_data, color='C2', linewidth=1.5, zorder=2)

title_pad_px = 6.0 * (100.0 / 72.0) + 1.0
y_title = 1.0 + title_pad_px / DH
ax.text(0.5, y_title, 'Archimedean Spiral: r = \u03b8/(2\u03c0)',
