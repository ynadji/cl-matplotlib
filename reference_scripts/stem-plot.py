...
plt.savefig('reference_images/stem-plot.svg')
print('Saved reference_images/stem-plot.svg')
plt.savefig('reference_images/stem-plot.pdf')
print('Saved reference_images/stem-plot.pdf')
