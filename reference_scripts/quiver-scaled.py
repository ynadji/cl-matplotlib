"""quiver-scaled.py — Reference for examples/quiver-scaled.lisp"""
import matplotlib
matplotlib.use('Agg')
...
ax.set_xlabel('X')
ax.set_ylabel('Y')
ax.set_title('Quiver Plot \u2014 Wind Patterns')
ax.grid(True)

fig.savefig('reference_images/quiver-scaled.png', dpi=100)
fig.savefig('reference_images/quiver-scaled.svg')
print('Saved reference_images/quiver-scaled.svg')
fig.savefig('reference_images/quiver-scaled.pdf')
print('Saved reference_images/quiver-scaled.pdf')
print('Saved reference_images/quiver-scaled.png')
