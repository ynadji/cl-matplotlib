...
plt.savefig('reference_images/inverted-axes.svg')
print('Saved reference_images/inverted-axes.svg')
plt.savefig('reference_images/inverted-axes.pdf')
print('Saved reference_images/inverted-axes.pdf')
plt.close()
