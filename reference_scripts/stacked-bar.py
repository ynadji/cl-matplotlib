...
plt.savefig('reference_images/stacked-bar.svg')
print('Saved reference_images/stacked-bar.svg')
plt.savefig('reference_images/stacked-bar.pdf')
print('Saved reference_images/stacked-bar.pdf')
