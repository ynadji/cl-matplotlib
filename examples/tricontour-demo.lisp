;;;; tricontour-demo.lisp — twin of reference_scripts/tricontour-demo.py
...
(let* ((n 200)
  ...
  (figure)
  (tricontour xs ys zs :n-levels 7)
  (dolist (ext '("png" "svg" "pdf"))
    (savefig (format nil "examples/tricontour-demo.~a" ext)))
  (format t "~&Saved examples/tricontour-demo.png~%"))
(uiop:quit)
