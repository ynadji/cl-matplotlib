;;;; tripcolor-demo.lisp — twin of reference_scripts/tripcolor-demo.py
...
(let* ((n 120)
       ...
       (cs (mapcar (lambda (x y) (* (sin (* x 0.6d0)) (cos (* y 0.5d0)))) xs ys)))
  (figure)
  (tripcolor xs ys cs)
  (dolist (ext '("png" "svg" "pdf"))
    (savefig (format nil "examples/tripcolor-demo.~a" ext)))
  (format t "~&Saved examples/tripcolor-demo.png~%"))
(uiop:quit)
