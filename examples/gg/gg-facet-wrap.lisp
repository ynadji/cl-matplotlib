;;;; gg-facet-wrap.lisp — faceted scatter (2x2)
;;;; Twin of reference_scripts/gg/gg-facet-wrap.py
...
(let* ((grp (loop for i from 0 below 20
  ...
  (gg:ggsave (gg:stack (gg:ggplot data (gg:aes :x :wt :y :mpg))
               (gg:geom-point)
               (gg:facet-wrap :grp))
             "examples/gg/gg-facet-wrap.png")
  (format t "~&Saved examples/gg/gg-facet-wrap.png~%"))
